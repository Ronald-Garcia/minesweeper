...
HD_PWD='C:/Users/rgarc/OneDrive/Desktop/FPGA/projects/minesweeper/minesweeper.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log minesweeper_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source minesweeper_top.tcl -notrace
