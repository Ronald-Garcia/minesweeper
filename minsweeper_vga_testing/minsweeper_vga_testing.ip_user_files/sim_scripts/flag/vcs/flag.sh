...
#
# Script generated by Vivado on Mon Nov 25 17:01:04 +0000 2024
...
#
# Usage        : flag.sh
#                flag.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                flag.sh [-reset_run]
#                flag.sh [-reset_log]
#                flag.sh [-help]
#
...
#                script (type 'flag.sh -help' for more information).
#
...
# script info
echo -e "flag.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./flag.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.flag xil_defaultlib.glbl -o flag_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./flag_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key flag_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc flag_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./flag.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: flag.sh [-help]\n\
Usage: flag.sh [-step]\n\
Usage: flag.sh [-lib_map_path]\n\
Usage: flag.sh [-reset_run]\n\
Usage: flag.sh [-reset_log]\n\
Usage: flag.sh [-keep_index]\n\
Usage: flag.sh [-noclean_files]\n\n\
