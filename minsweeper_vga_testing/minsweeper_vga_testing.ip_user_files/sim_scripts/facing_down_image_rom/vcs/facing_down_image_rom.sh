...
#
# Script generated by Vivado on Sun Nov 24 16:47:26 +0000 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : facing_down_image_rom.sh
...
#
# Usage        : facing_down_image_rom.sh
#                facing_down_image_rom.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                facing_down_image_rom.sh [-reset_run]
#                facing_down_image_rom.sh [-reset_log]
#                facing_down_image_rom.sh [-help]
#
...
#                script (type 'facing_down_image_rom.sh -help' for more information).
#
...
# script info
echo -e "facing_down_image_rom.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./facing_down_image_rom.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.facing_down_image_rom xil_defaultlib.glbl -o facing_down_image_rom_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./facing_down_image_rom_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key facing_down_image_rom_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc facing_down_image_rom_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./facing_down_image_rom.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: facing_down_image_rom.sh [-help]\n\
Usage: facing_down_image_rom.sh [-step]\n\
Usage: facing_down_image_rom.sh [-lib_map_path]\n\
Usage: facing_down_image_rom.sh [-reset_run]\n\
Usage: facing_down_image_rom.sh [-reset_log]\n\
Usage: facing_down_image_rom.sh [-keep_index]\n\
Usage: facing_down_image_rom.sh [-noclean_files]\n\n\
