...
#
# Script generated by Vivado on Wed Nov 27 17:41:43 +0000 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : flag_bcm.sh
...
#
# Usage        : flag_bcm.sh
#                flag_bcm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                flag_bcm.sh [-reset_run]
#                flag_bcm.sh [-reset_log]
#                flag_bcm.sh [-help]
#
...
#                script (type 'flag_bcm.sh -help' for more information).
#
...
# script info
echo -e "flag_bcm.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./flag_bcm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.flag_bcm xil_defaultlib.glbl -o flag_bcm_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./flag_bcm_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key flag_bcm_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc flag_bcm_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./flag_bcm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: flag_bcm.sh [-help]\n\
Usage: flag_bcm.sh [-step]\n\
Usage: flag_bcm.sh [-lib_map_path]\n\
Usage: flag_bcm.sh [-reset_run]\n\
Usage: flag_bcm.sh [-reset_log]\n\
Usage: flag_bcm.sh [-keep_index]\n\
Usage: flag_bcm.sh [-noclean_files]\n\n\
