...
#
# Script generated by Vivado on Mon Nov 25 16:54:24 +0000 2024
...
#
# Usage        : num_3.sh
#                num_3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                num_3.sh [-reset_run]
#                num_3.sh [-reset_log]
#                num_3.sh [-help]
#
...
#                script (type 'num_3.sh -help' for more information).
#
...
# script info
echo -e "num_3.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./num_3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.num_3 xil_defaultlib.glbl -o num_3_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./num_3_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key num_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc num_3_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./num_3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: num_3.sh [-help]\n\
Usage: num_3.sh [-step]\n\
Usage: num_3.sh [-lib_map_path]\n\
Usage: num_3.sh [-reset_run]\n\
Usage: num_3.sh [-reset_log]\n\
Usage: num_3.sh [-keep_index]\n\
Usage: num_3.sh [-noclean_files]\n\n\
