...
#
# Script generated by Vivado on Wed Nov 27 17:38:04 +0000 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bomb_rcm.sh
...
#
# Usage        : bomb_rcm.sh
#                bomb_rcm.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bomb_rcm.sh [-reset_run]
#                bomb_rcm.sh [-reset_log]
#                bomb_rcm.sh [-help]
#
...
#                script (type 'bomb_rcm.sh -help' for more information).
#
...
# script info
echo -e "bomb_rcm.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bomb_rcm.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bomb_rcm xil_defaultlib.glbl -o bomb_rcm_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bomb_rcm_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bomb_rcm_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bomb_rcm_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bomb_rcm.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bomb_rcm.sh [-help]\n\
Usage: bomb_rcm.sh [-step]\n\
Usage: bomb_rcm.sh [-lib_map_path]\n\
Usage: bomb_rcm.sh [-reset_run]\n\
Usage: bomb_rcm.sh [-reset_log]\n\
Usage: bomb_rcm.sh [-keep_index]\n\
Usage: bomb_rcm.sh [-noclean_files]\n\n\
