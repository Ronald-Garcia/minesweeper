...
#
# Script generated by Vivado on Mon Nov 25 17:01:53 +0000 2024
...
#
# Usage        : bomb.sh
#                bomb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bomb.sh [-reset_run]
#                bomb.sh [-reset_log]
#                bomb.sh [-help]
#
...
#                script (type 'bomb.sh -help' for more information).
#
...
# script info
echo -e "bomb.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bomb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bomb xil_defaultlib.glbl -o bomb_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bomb_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bomb_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bomb_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bomb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bomb.sh [-help]\n\
Usage: bomb.sh [-step]\n\
Usage: bomb.sh [-lib_map_path]\n\
Usage: bomb.sh [-reset_run]\n\
Usage: bomb.sh [-reset_log]\n\
Usage: bomb.sh [-keep_index]\n\
Usage: bomb.sh [-noclean_files]\n\n\
