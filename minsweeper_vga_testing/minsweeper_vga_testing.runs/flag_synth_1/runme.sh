...
HD_PWD='C:/Users/rgarc/OneDrive/Desktop/FPGA/projects/minessweeper_vga_testing/minsweeper_vga_testing/minsweeper_vga_testing.runs/flag_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flag.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flag.tcl
