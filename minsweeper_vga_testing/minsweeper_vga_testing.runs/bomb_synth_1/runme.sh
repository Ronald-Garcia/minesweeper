...
HD_PWD='C:/Users/rgarc/OneDrive/Desktop/FPGA/projects/minessweeper_vga_testing/minsweeper_vga_testing/minsweeper_vga_testing.runs/bomb_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bomb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bomb.tcl
